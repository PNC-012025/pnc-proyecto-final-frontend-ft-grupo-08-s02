...
const RegistrosPage: React.FC = () => {
    ...
    // Form fields for social instructors
    ...
    useEffect(() => {
        ...
        if (data) {
            ...
            setRegistros(all.filter(r => r.estudianteId === userId && r.estado === 'APROBADO'));
        }
    }, [userId]);
    ...
    const handleDownloadPdf = async () => {
        ...
        pdf.save(`asistencia_${userId}_${new Date().toISOString().slice(0, 10)}.pdf`);
    };
    ...
    return (
        <div className="space-y-6 p-4">
            ...
            {/* Show form only for social instructors */}
            {user?.rol === 'INSTRUCTOR_SOCIAL' && (
                    ...
                    <table className="min-w-full bg-white rounded shadow">
                        ...
                        <tbody>
                            {registros.length > 0 ? (
                                ...
                                <tr><td colSpan={6} className="px-4 py-2 text-center text-gray-500">No hay registros aprobados.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
